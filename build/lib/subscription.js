...
class Subscription extends _fastbill_api.FastbillAPI {
    ...
    create(subscription) {
        ...
        return new Promise((resolve, reject) => {
            ...
            (0, _type_handler.typeOf)(subscription).mustBe('object');
    ...
    setUsageData(id, usage) {
        ...
        return new Promise((resolve, reject) => {
            ...
            (0, _type_handler.typeOf)(id).mustBe('number');
            (0, _type_handler.typeOf)(usage).mustBe('object');
    ...
    getUsageData(id, start, end) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (start) {
                (0, _type_handler.typeOf)(start).mustBe('number');
            }

            if (end) {
                (0, _type_handler.typeOf)(end).mustBe('number');
            }
    ...
    deleteUsageData(usage_id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            let usage = {};
            (0, _type_handler.typeOf)(usage_id).mustBe('number');
    ...
    getUpcomingAmount(filters) {
        ...
        return new Promise((resolve, reject) => {
            ...
            (0, _type_handler.typeOf)(filters).mustBe('object');
    ...
    setaddon(id, addon) {
        ...
        return new Promise((resolve, reject) => {
            ...
            (0, _type_handler.typeOf)(id).mustBe('number');
            (0, _type_handler.typeOf)(addon).mustBe('object');
